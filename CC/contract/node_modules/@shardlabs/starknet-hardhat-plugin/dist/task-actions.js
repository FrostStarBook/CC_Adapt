...
exports.starknetDeployAccountAction = exports.starknetCallAction = exports.starknetInvokeAction = exports.starknetVoyagerAction = exports.starknetDeployAction = exports.starknetCompileAction = void 0;
...
function getGatewayUrl(args, hre) {
    ...
    const network = (0, utils_1.getNetwork)(networkName, hre, "starknet-network");
...
function getVerificationUrl(networkName, hre, origin) {
    ...
    const network = (0, utils_1.getNetwork)(networkName, hre, origin);
