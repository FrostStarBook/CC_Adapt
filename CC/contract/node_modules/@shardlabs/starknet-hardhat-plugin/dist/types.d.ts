...
export declare class StarknetContractFactory {
     ...
     */
    deploy(constructorArguments?: StringMap, addressSalt?: string): Promise<StarknetContract>;
...
export declare class StarknetContract {
     ...
     */
    invoke(functionName: string, args?: StringMap, signature?: Array<Numeric>, wallet?: Wallet): Promise<void>;
    /**
     ...
     * @returns a Promise that resolves when the status of the transaction is at least `PENDING`
     */
    call(functionName: string, args?: StringMap, signature?: Array<Numeric>, wallet?: Wallet, blockNumber?: string): Promise<StringMap>;
}
export {};
