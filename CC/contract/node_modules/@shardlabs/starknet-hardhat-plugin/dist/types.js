...
class StarknetContractFactory {
     ...
     */
    deploy(constructorArguments, addressSalt) {
        return __awaiter(this, void 0, void 0, function* () {
...
class StarknetContract {
    ...
    invokeOrCall(choice, functionName, args, signature, wallet, blockNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.address) {
     ...
     */
    invoke(functionName, args, signature, wallet) {
        return __awaiter(this, void 0, void 0, function* () {
            const executed = yield this.invokeOrCall("invoke", functionName, args, signature, wallet);
            const txHash = extractTxHash(executed.stdout.toString());
            return new Promise((resolve, reject) => {
                iterativelyCheckStatus(txHash, this.starknetWrapper, this.gatewayUrl, this.feederGatewayUrl, () => resolve(), error => {
     ...
     * @returns a Promise that resolves when the status of the transaction is at least `PENDING`
     */
    call(functionName, args, signature, wallet, blockNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            const blockNum = blockNumber || constants_1.PENDING_BLOCK_NUMBER;
            const executed = yield this.invokeOrCall("call", functionName, args, signature, wallet, blockNum);
            const func = this.abi[functionName];
