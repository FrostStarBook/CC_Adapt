...
mod tests {
    ...
    use starknet::ContractAddress;
    use openzeppelin::token::erc20::ERC20;
    use cc_map::generator::dungeons_generator::{Settings, generate_rooms, Room, RoomSettings};

    #[test]
    #[ignore]
    #[available_gas(30000000000000000000000000000000)]
    fn test_generate_room() {
        let settings = Settings { size: 3, length: 3, seed: 3, counter: 3 };
        let (mut rooms, mut floor) = generate_rooms(@settings);
